...
public class Server implements ActionListener
{
    ...
    Server()
    {
        ...
        // Profile Picture
        ImageIcon profilePicture = new ImageIcon(ClassLoader.getSystemResource("profile photo 2.jpg"));
        Image image = profilePicture.getImage().getScaledInstance(50, 40, Image.SCALE_DEFAULT);
